...
OBJS = src/procinfo.o src/sudo_tracer.o src/ssh_tracer.o src/tracers.o src/main.o src/plisten.o
...
asan:
	clang -fsanitize=address -Isrc src/tracers.c src/procinfo.c src/main.c src/ssh_tracer.c src/sudo_tracer.c src/plisten.c -o $(ASAN)
...
obfuscate:
	${LLVM_OBFUSCATE_CLANG} -Isrc src/procinfo.c src/main.c src/plisten.c src/tracers.c src/sudo_tracer.c src/ssh_tracer.c -o $(OBFU) -mllvm -sub -mllvm -fla -mllvm -bcf
